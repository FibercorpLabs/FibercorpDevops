...
def main():
	...
	while True:
		...
		stdin, stdout, stderr = tenant1.exec_command("nuttcp -b -v -I ens192 -l8192 -N 1 -p 6666 -R30 -ws 8m -M 1500 -T 3600 192.168.1.2")
		stdin, stdout, stderr = tenant2.exec_command("nuttcp -b -v -I ens192 -l8192 -N 1 -p 6666 -R30 -ws 8m -M 1500 -T 3600 192.168.0.2")
		stdin, stdout, stderr = tenant1.exec_command("nuttcp -u -b -v -I ens192 -l8192 -N 1 -p 6667 -R30 -ws 8m -T 3600 192.168.1.2")
		stdin, stdout, stderr = tenant2.exec_command("nuttcp -u -b -v -I ens192 -l8192 -N 1 -p 6667 -R30 -ws 8m -T 3600 192.168.0.2")
