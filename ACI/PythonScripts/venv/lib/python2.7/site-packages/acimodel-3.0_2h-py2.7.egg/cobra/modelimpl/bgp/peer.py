...
class Peer(Mo):
    ...
    prop._addConstant("bgp:PeerpeerRole_failed_flag", None, 16384)
    prop._addConstant("bgp:PeerprivateASctrl_failed_flag", None, 32768)
    prop._addConstant("bgp:PeersrcIf_failed_flag", None, 65536)
    prop._addConstant("bgp:Peerttl_failed_flag", None, 262144)
    prop._addConstant("bgp:Peertype_failed_flag", None, 524288)
