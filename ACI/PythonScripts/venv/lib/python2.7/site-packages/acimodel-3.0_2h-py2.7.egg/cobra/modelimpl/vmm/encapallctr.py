...
class EncapAllctr(Mo):
    ...
    prop._addConstant("epg-pol-enforce-unsupported", "intra-epg-isolation-is-not-supported-in-avs-vlan-mode-and-dvs-vxlan-mode-vmm-domains", 16777216)
    ...
    prop._addConstant("vnic-miss-epg-fault", "vnic-is-attached-to-an-invalid-dvs-port-group", 16)
