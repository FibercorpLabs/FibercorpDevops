...
class VfcIf(Mo):
    ...
    prop = PropMeta("str", "fcId", "fcId", 24689, PropCategory.REGULAR)
    prop.label = "Interna flogi FcId."
    prop.isOper = True
    meta.props.add("fcId", prop)

    prop = PropMeta("str", "fcMap", "fcMap", 24691, PropCategory.REGULAR)
    prop.label = "FCOE Mac Address Prefix"
    prop.isOper = True
    meta.props.add("fcMap", prop)

    prop = PropMeta("str", "fcfPrio", "fcfPrio", 24692, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fipKaIntvl", "fipKaIntvl", 24690, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 24693, PropCategory.REGULAR)
    prop.label = "VFC mode"
    prop.isOper = True
    ...
    prop = PropMeta("str", "peerMac", "peerMac", 27127, PropCategory.REGULAR)
    prop.label = "Peer Mac, used in VE."
    prop.isOper = True
    meta.props.add("peerMac", prop)

    prop = PropMeta("str", "peerWwn", "peerWwn", 24688, PropCategory.REGULAR)
    prop.label = "Peer WWN."
    prop.isOper = True
