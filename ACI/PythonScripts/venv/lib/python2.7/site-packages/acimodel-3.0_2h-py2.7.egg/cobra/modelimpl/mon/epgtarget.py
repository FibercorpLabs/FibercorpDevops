...
class EPGTarget(Mo):
    ...
    prop._addConstant("orchsRsFromRPToL3OutInstP", "internal/external-ip-address-pool-(orchs.rsfromrptol3outinstp)", 9568)
    prop._addConstant("orchsRsIpPoolRef", "internal/external-ip-address-pool-(orchs.rsippoolref)", 9566)
