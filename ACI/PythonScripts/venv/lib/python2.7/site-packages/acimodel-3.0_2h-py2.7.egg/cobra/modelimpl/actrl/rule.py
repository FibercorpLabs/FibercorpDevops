...
class Rule(Mo):
    ...
    prop._addConstant("actrl:RuledPcTag_failed_flag", None, 16)
    prop._addConstant("actrl:Ruledescr_failed_flag", None, 4)
    prop._addConstant("actrl:Ruledirection_failed_flag", None, 32)
    prop._addConstant("actrl:RulefltId_failed_flag", None, 64)
    prop._addConstant("actrl:Ruleid_failed_flag", None, 128)
    prop._addConstant("actrl:RulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:RulemarkDscp_failed_flag", None, 256)
    prop._addConstant("actrl:RulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:RulemonPolDn_failed_flag", None, 524288)
    prop._addConstant("actrl:RulenameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:Rulename_failed_flag", None, 1)
    prop._addConstant("actrl:Ruleprio_failed_flag", None, 2048)
    prop._addConstant("actrl:RuleqosGrp_failed_flag", None, 4096)
    prop._addConstant("actrl:RulesPcTag_failed_flag", None, 8192)
    prop._addConstant("actrl:RulescopeId_failed_flag", None, 16384)
    prop._addConstant("actrl:Ruletype_failed_flag", None, 32768)
