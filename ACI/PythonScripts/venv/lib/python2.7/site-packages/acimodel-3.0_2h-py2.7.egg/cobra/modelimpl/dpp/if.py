...
class If(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("dpp:Ifdirection_failed_flag", None, 1)
    prop._addConstant("dpp:Ifid_failed_flag", None, 2)
    prop._addConstant("dpp:Iflayer_failed_flag", None, 4)
    ...
    prop._addConstant("dpp:IfmonPolDn_failed_flag", None, 8)
