...
class If(Mo):
    ...
    meta.readAccessMask = 0x800581c00002001
    ...
    prop._addConstant("tunnel:IfidRequestorDn_failed_flag", None, 128)
    prop._addConstant("tunnel:Ifid_failed_flag", None, 4)
    prop._addConstant("tunnel:IfkeepAlvIntvl_failed_flag", None, 512)
    prop._addConstant("tunnel:IfkeepAlvRetries_failed_flag", None, 1024)
    prop._addConstant("tunnel:IflcC_failed_flag", None, 2048)
    prop._addConstant("tunnel:IflcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("tunnel:Ifmac_failed_flag", None, 4096)
    prop._addConstant("tunnel:IfmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("tunnel:IfmonPolDn_failed_flag", None, 8192)
    prop._addConstant("tunnel:Ifname_failed_flag", None, 1)
    prop._addConstant("tunnel:Ifsrc_failed_flag", None, 65536)
    prop._addConstant("tunnel:IftLayer_failed_flag", None, 131072)
    prop._addConstant("tunnel:IftType_failed_flag", None, 262144)
    prop._addConstant("tunnel:Iftype_failed_flag", None, 4194304)
    prop._addConstant("tunnel:IfunderlayVrfName_failed_flag", None, 8388608)
    prop._addConstant("tunnel:IfvrfName_failed_flag", None, 16777216)
    ...
    prop._addConstant("non-fabric-golf", "non-fabric-golf", 2048)
