...
class DevConfIssue(Mo):
    ...
    prop._addConstant("invalid-epg-useg-attr-set", "one-of-both-termnode(s)-in-the-graph-has-epg-with-useg-attribute-set", 123)
    ...
    prop._addConstant("svc-graph-has-msite-epg", "l4-l7-service-graph-has-multi-site-epg(s)", 124)
