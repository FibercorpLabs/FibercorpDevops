...
class MgmtRule(Mo):
    ...
    prop._addConstant("actrl:MgmtRuledPcTag_failed_flag", None, 16)
    prop._addConstant("actrl:MgmtRuledescr_failed_flag", None, 4)
    prop._addConstant("actrl:MgmtRuledirection_failed_flag", None, 32)
    prop._addConstant("actrl:MgmtRulefltId_failed_flag", None, 64)
    prop._addConstant("actrl:MgmtRuleid_failed_flag", None, 128)
    prop._addConstant("actrl:MgmtRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:MgmtRulemarkDscp_failed_flag", None, 256)
    prop._addConstant("actrl:MgmtRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:MgmtRulemonPolDn_failed_flag", None, 524288)
    prop._addConstant("actrl:MgmtRulenameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:MgmtRulename_failed_flag", None, 1)
    prop._addConstant("actrl:MgmtRuleprio_failed_flag", None, 2048)
    prop._addConstant("actrl:MgmtRuleqosGrp_failed_flag", None, 4096)
    prop._addConstant("actrl:MgmtRulesPcTag_failed_flag", None, 8192)
    prop._addConstant("actrl:MgmtRulescopeId_failed_flag", None, 16384)
    prop._addConstant("actrl:MgmtRuletype_failed_flag", None, 32768)
