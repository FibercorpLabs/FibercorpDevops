...
class Dom(Mo):
    ...
    prop._addConstant("bgp:DomholdIntvl_failed_flag", None, 256)
    prop._addConstant("bgp:DomkaIntvl_failed_flag", None, 512)
    prop._addConstant("bgp:DomlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("bgp:DommaxAsLimit_failed_flag", None, 1024)
    prop._addConstant("bgp:DommodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("bgp:Dommode_failed_flag", None, 2048)
    prop._addConstant("bgp:DommonPolDn_failed_flag", None, 4096)
    prop._addConstant("bgp:DommsiteClusterId_failed_flag", None, 8192)
    prop._addConstant("bgp:Domname_failed_flag", None, 1)
    prop._addConstant("bgp:Domrd_failed_flag", None, 262144)
    prop._addConstant("bgp:DomrtrId_failed_flag", None, 524288)
    prop._addConstant("bgp:Domtype_failed_flag", None, 1048576)
