...
class PfxEntry(Mo):
    ...
    prop._addConstant("actrl:PfxEntrylocalConsCount_failed_flag", None, 128)
    prop._addConstant("actrl:PfxEntrymodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:PfxEntrymonPolDn_failed_flag", None, 256)
    prop._addConstant("actrl:PfxEntrynameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:PfxEntryname_failed_flag", None, 1)
    prop._addConstant("actrl:PfxEntrypcTag_failed_flag", None, 2048)
    prop._addConstant("actrl:PfxEntrypfxInstrScope_failed_flag", None, 4096)
    prop._addConstant("actrl:PfxEntryremoteConsCount_failed_flag", None, 8192)
