...
class CktEp(Mo):
    ...
    prop._addConstant("qinq:CktEpclassPrefOperSt_failed_flag", None, 2097152)
    prop._addConstant("qinq:CktEpctrl_failed_flag", None, 8)
    prop._addConstant("qinq:CktEpencap_failed_flag", None, 32768)
    prop._addConstant("qinq:CktEpenfPref_failed_flag", None, 65536)
    prop._addConstant("qinq:CktEpepUpSeqNum_failed_flag", None, 16)
    prop._addConstant("qinq:CktEpepgDn_failed_flag", None, 131072)
    prop._addConstant("qinq:CktEpfabEncap_failed_flag", None, 4194304)
    ...
    prop._addConstant("qinq:CktEpmonPolDn_failed_flag", None, 8388608)
    prop._addConstant("qinq:CktEpname_failed_flag", None, 1)
    prop._addConstant("qinq:CktEppcTag_failed_flag", None, 262144)
    prop._addConstant("qinq:CktEpqosPrio_failed_flag", None, 1048576)
