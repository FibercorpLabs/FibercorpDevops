...
class CktEp(Mo):
    ...
    prop._addConstant("vlan:CktEpclassPrefOperSt_failed_flag", None, 2097152)
    prop._addConstant("vlan:CktEpctrl_failed_flag", None, 8)
    prop._addConstant("vlan:CktEpencap_failed_flag", None, 32768)
    prop._addConstant("vlan:CktEpenfPref_failed_flag", None, 65536)
    prop._addConstant("vlan:CktEpepUpSeqNum_failed_flag", None, 16)
    prop._addConstant("vlan:CktEpepgDn_failed_flag", None, 131072)
    prop._addConstant("vlan:CktEpfabEncap_failed_flag", None, 8388608)
    ...
    prop._addConstant("vlan:CktEpmonPolDn_failed_flag", None, 16777216)
    prop._addConstant("vlan:CktEpname_failed_flag", None, 1)
    prop._addConstant("vlan:CktEppcTag_failed_flag", None, 262144)
    prop._addConstant("vlan:CktEpqosPrio_failed_flag", None, 1048576)
