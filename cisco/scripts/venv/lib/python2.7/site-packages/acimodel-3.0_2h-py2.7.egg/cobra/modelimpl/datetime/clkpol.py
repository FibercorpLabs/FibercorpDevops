...
class ClkPol(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("datetime:ClkPoladminSt_failed_flag", None, 32)
    prop._addConstant("datetime:ClkPolauthSt_failed_flag", None, 64)
    ...
    prop._addConstant("datetime:ClkPolmonPolDn_failed_flag", None, 2048)
    ...
    prop._addConstant("datetime:ClkPolpolDn_failed_flag", None, 65536)
