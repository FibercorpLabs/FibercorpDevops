...
class SnmpRule(Mo):
    ...
    prop._addConstant("actrl:SnmpRuledPcTag_failed_flag", None, 16)
    prop._addConstant("actrl:SnmpRuledescr_failed_flag", None, 4)
    prop._addConstant("actrl:SnmpRuledirection_failed_flag", None, 32)
    prop._addConstant("actrl:SnmpRulefltId_failed_flag", None, 64)
    prop._addConstant("actrl:SnmpRuleid_failed_flag", None, 128)
    prop._addConstant("actrl:SnmpRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:SnmpRulemarkDscp_failed_flag", None, 256)
    ...
    prop._addConstant("actrl:SnmpRuleprio_failed_flag", None, 2048)
    prop._addConstant("actrl:SnmpRuleqosGrp_failed_flag", None, 4096)
    prop._addConstant("actrl:SnmpRulesPcTag_failed_flag", None, 8192)
    prop._addConstant("actrl:SnmpRulescopeId_failed_flag", None, 16384)
    prop._addConstant("actrl:SnmpRuletype_failed_flag", None, 32768)
